...
?>
			...
			<form action='user.php' method='POST'>
				...
				<table width="70%" align="center">
					<tr>
						<td class="brdss" style="color: #000000;">
							<b>From</b>
						</td>
						<td class="brdss">
							<select name=t7>
		...
		<section id="rides">
			<br><br><br><br>
			<h2>Last 5 rides</h2>
			<table style="width:50%" border="1" align="center"></section>
...
?>
			<?php mysql_connect("localhost","root"); mysql_select_db("metro"); $res=mysql_query("SELECT * FROM rides WHERE mcn1='$mcn' order by date1 desc limit 5"); $cnt=mysql_num_rows($res); mysql_query("delete from rides where fare=0.00");
			for($i=0;$i<$cnt;$i++) { $a1=mysql_result($res,$i,"mcn1"); $a2=mysql_result($res,$i,"user_name1"); $a3=mysql_result($res,$i,"frm1"); $a4=mysql_result($res,$i,"to1"); $a6=mysql_result($res,$i,"fare"); $a5=mysql_result($res,$i,"date1");
			mysql_query("delete from rides where fare=0.00"); echo"<tr><td>$a1</td><td>$a2</td><td>$a3</td><td>$a4</td><td>$a6</td><td>$a5</td></tr>"; } ?>
...
<section id="recharge" class="block background01 animatedParent animateOnce">
	<div class="container">
		<div class="row">
			<div class="projects">
				<h2 class="animated fadeIn slow">
					<font color=red size=5px>Recharge</font>
					<div id="Carousel06d" class="carousel slide">
						<div class="portfolio">
							<div id="ourprojects" class="carousel-inner">
								<div class="holder animated fadeIn slow"></div>
							</div>
						</div>
					</div>
				</div>
...
<section id="balance" class="block background01 animatedParent animateOnce">
	...
	<?php mysql_connect("localhost","root"); mysql_select_db("metro"); $res99=mysql_query("SELECT * FROM signup WHERE mcn='$mcn' "); $cnt=mysql_num_rows($res99); for($i=0;$i<$cnt;$i++) { $bal=mysql_result($res99,$i,"balance"); } mysql_query("delete from
	rides where fare=0"); echo "<center><font color=purple size=10px>₹ $bal </font></center>"; if($bal<20) { echo "<font color=red>Not enough balance</font>"; } ?>
