...
<body>
   <div class="form">
        ...
        if($a==1)
        {
          echo"<tr bgcolor=red><td colspan=2><font size=4 color=red><center>User Id Already exists</font></td></tr>";

        }
        if($a==2)
        {
          echo"<tr bgcolor=yellow><td colspan=2><font color=red><center>User created succesfully</font></td></tr>";
        }
      ?>
      <ul class="tab-group">
